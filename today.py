...
if __name__ == '__main__':
    """
    Original generator by Andrew Grant (Andrew6rant), 2022-2025.
    Adapted for gauryash; see credit.md.
    """
    ...
    # Treat GitHub account creation as uptime so no private birth date is needed.
